...
public class GaussianElimination {
     ...
     */
    public int printNext(double[] sol) {
        ...
        int temp = 0;
        for (int i = 0; i < N; i++) {
            temp += sol[i] * Math.pow(N, N - 1 - i);
        }
        System.out.println("\u001B[31;1m" + temp);
        System.out.println();
        return temp;
    }

    public void printIth(double[] sol,int value) {
        int N = sol.length;
        System.out.println("\nSolution : ");

        int temp = 0;
        for (int i = 0; i < N; i++) {
            temp += sol[i] * Math.pow(value, N - 1 - i);
        }
        System.out.println("\u001B[31;1m" + temp);
        System.out.println();
    }
